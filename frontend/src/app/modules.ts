...
export const MODULES: ModuleNavEntry[] = [
  ...
  { name: 'manufacturing', label: 'Manufacturing', schema: 'manufacturing', phase: 'Phase 3 — Manufacturing ERP', implemented: true },
  { name: 'crm', label: 'CRM', schema: 'crm', phase: 'Phase 4 — CRM & HRMS', implemented: true },
  { name: 'hrms', label: 'HRMS', schema: 'hrms', phase: 'Phase 4 — CRM & HRMS', implemented: true },
  { name: 'quality', label: 'Quality', schema: 'quality', phase: 'Phase 5 — Quality & Maintenance', implemented: true },
