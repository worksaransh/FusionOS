...
public sealed class UpdateAttributeDefinitionCommandHandler : IRequestHandler<UpdateAttributeDefinitionCommand, AttributeDefinitionDto>
{
    private readonly IAttributeDefinitionRepository _repository;
    private readonly IUnitOfWork _unitOfWork;

    public UpdateAttributeDefinitionCommandHandler(IAttributeDefinitionRepository repository, IUnitOfWork unitOfWork)
    {
    ...
    public async Task<AttributeDefinitionDto> Handle(UpdateAttributeDefinitionCommand request, CancellationToken cancellationToken)
    {
        ...
        definition.UpdateDetails(request.Name);
