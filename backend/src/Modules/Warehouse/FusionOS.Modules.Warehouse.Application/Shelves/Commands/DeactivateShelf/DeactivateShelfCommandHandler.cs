...
public sealed class DeactivateShelfCommandHandler : IRequestHandler<DeactivateShelfCommand, ShelfDto>
{
    ...
    public DeactivateShelfCommandHandler(IShelfRepository repository, FusionOS.Modules.Warehouse.Application.Warehouses.Contracts.IUnitOfWork unitOfWork)
    {
        _repository = repository;
        _unitOfWork = unitOfWork;
    }

    public async Task<ShelfDto> Handle(DeactivateShelfCommand request, CancellationToken cancellationToken)
    {
