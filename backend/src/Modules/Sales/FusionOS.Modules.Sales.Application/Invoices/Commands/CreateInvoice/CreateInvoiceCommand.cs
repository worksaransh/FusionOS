...
public sealed record CreateInvoiceCommand(Guid CompanyId, Guid SalesOrderId, Guid CustomerId, IReadOnlyList<InvoiceLineInput> Lines, Guid? SalesPersonId = null)
