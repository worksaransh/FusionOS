...
public sealed class UpdateMaintenanceScheduleCommandHandler : IRequestHandler<UpdateMaintenanceScheduleCommand, MaintenanceScheduleDto>
{
    private readonly IMaintenanceScheduleRepository _repository;
    private readonly IUnitOfWork _unitOfWork;

    public UpdateMaintenanceScheduleCommandHandler(IMaintenanceScheduleRepository repository, IUnitOfWork unitOfWork)
    {
    ...
    public async Task<MaintenanceScheduleDto> Handle(UpdateMaintenanceScheduleCommand request, CancellationToken cancellationToken)
    {
        ...
        schedule.UpdateDetails(request.Frequency, request.Description, request.NextDueDate);
